...
class KademliaServerWorker extends Thread {
    ...
    private final ConcurrentHashMap<String, Consumer<KademliaMessage>> responses;

    public KademliaServerWorker(BubblegumNode localNode, ConcurrentBlockingQueue<DatagramPacket> queue, ConcurrentHashMap<String, Consumer<KademliaMessage>> responses) {
        this.queue = queue;
...
//                        this.print("Callback found for " + message.getExchangeID());
                        ...
                        try {
                            ...
                            this.localNode.getExecutionContext().addCallbackActivity(this.localNode.getIdentifier(), pingReply);
                        ...
                        try {
                            ...
                            this.localNode.getExecutionContext().addCallbackActivity(this.localNode.getIdentifier(), findNodeReply);
                        ...
                        try {
                            ...
                            this.localNode.getExecutionContext().addCallbackActivity(this.localNode.getIdentifier(), storeActivity);
